...
public class CollegeInfo {
	...
	public void insertCollegeInfo () {
		...
		System.out.println("Muir before properties: "+Muir.toString());
		...
		Muir.setProperty("muir_ge",muirGE);
		Muir.setProperty("area_1", area1);
		Muir.setProperty("area_2", area2);
		Muir.setProperty("area_3", area3);

		System.out.println("Muir after properties: "+Muir.toString());
		...
		System.out.println(Util.findEntity(college.getKey()).toString());

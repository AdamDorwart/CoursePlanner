...
public class CollegeInfo {
	...
	public void insertCollegeInfo() {
		...
		Muir.setProperty("description","Muir College encourages awareness of environmental "+ "issues and involvement in environmental preservation and "+ "sustainability.");
